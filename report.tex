...
{\large \color{black!80!black}{\textbf{Athens, Greece}}\\[0.2cm] \color{blue!90!black}20 Ιανουαρίου 2026}
...
Nonlienar Opinion Dynamics (NOD) models are used to describe how opinions evolve over time within a population. They are fast and flexible, 
...
\footnote{The code is available in this Github repository: } 
